...
void prepareVAO() {
     //geometry = Geometry::createBox(2.0f);// 这里 createBox 是静态成员函数，不能用new
    //geometry = Geometry::createPlane(2.0f,1.0f);
    
    try {
        geometry = Geometry::createFromOBJ("E:/IT-Furnace/OpenGl/mindray/Framework/resource/objs/rock/Stone.obj");
        //geometry = Geometry::createFromOBJ("E:/IT-Furnace/OpenGl/mindray/Framework/resource/objs/tri.obj");
        //geometry = Geometry::createFromOBJ("E:/IT-Furnace/OpenGl/mindray/Framework/resource/objs/pyramid.obj");
    }
...
void prepareTexture() {
    ...
    texture = new Texture("E:/IT-Furnace/OpenGl/mindray/Framework/resource/obj/rock/diffuso.tif", 0);   // 绑定0号纹理单元
}
void prepareCamera() {
