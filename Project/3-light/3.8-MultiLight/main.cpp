...
void prepare() {
    ...
    std::string fragmentshaderPath = "E:/IT-Furnace/OpenGl/mindray/Framework/resource/shaders/Blinn-Phong/Blinn-phong-Light-encapsulation.frag";
    ...
    pointLight->setSpecularIntensity(10.0f);
