...
void renderIMGUI_config() {
    ...
    if (ImGui::TreeNode("Material Settings")) {
        ...
        ImGui::InputFloat3("Mat Ambient vec", (float*)&materialConfig.ambient);

        ImGui::Text("Diffuse Color (Material)");
        ImGui::InputFloat3("Mat Diffuse vec", (float*)&materialConfig.diffuse);

        ImGui::Text("Specular Color (Material)");
        ImGui::InputFloat3("Mat Specular vec", (float*)&materialConfig.specular);
