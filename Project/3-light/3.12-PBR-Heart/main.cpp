...
void prepare() {
    ...
    /*std::string TalbedoPath = std::string(TEXTURE_DIR) + "/Pangmao/BaseColor.jpg";
    std::string TaoPath = std::string(TEXTURE_DIR) + "/pbrheart/AO.png";
    std::string TmetallicPath = std::string(TEXTURE_DIR) + "/Pangmao/Metallic.jpg";
    std::string TnormalPath = std::string(TEXTURE_DIR) + "/Pangmao/NormalMap.png";
    std::string TroughnessPath = std::string(TEXTURE_DIR) + "/Pangmao/Roughness.jpg";*/
