...
void prepare() {
    std::string vertexshaderPath = "E:/IT-Furnace/OpenGl/mindray/Framework/resource/shaders/3.9-LightArray/LightArray.vert";
    std::string fragmentshaderPath = "E:/IT-Furnace/OpenGl/mindray/Framework/resource/shaders/3.9-LightArray/LightArray.frag";
    ...
    pointLight1->setColor(glm::vec3(1.0f));
    ...
    pointLight3->setPosition(glm::vec3(0.0f, 0.0f, -2.0f));
    ...
    pointLight4->setPosition(glm::vec3(-2.0f, 0.0f, 0.0f));
    pointLight4->setColor(glm::vec3(0.0f,0.0f,1.0f));
    ...
    ambLight->setColor(glm::vec3{ 0.4f });
}
